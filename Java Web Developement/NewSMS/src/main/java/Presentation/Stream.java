...
public class Stream {
    public static void main(String[] args) {
        ...
        List<Student> students = Arrays.asList(
            ...
            new Student(2, "Kavya", Arrays.asList(new Course("JAVA", "CSE4001",3), new Course("Python", "CSE4007",2)), 9.5),
            new Student(3, "Sushma", Arrays.asList(new Course("C", "CSE4003",3), new Course("Python", "CSE4007",2)), 8.3),
